...
class AddCommandNew extends ConsumerWidget {
  const AddCommandNew({Key? key}) : super(key: key);
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              ref
                                  .read(addCommandViewModel.notifier)
                                  .extractIcon(
                                      commandState.command!, commandState.id!);
                            },
                            child: const Text("extract App Icons"),
                          ),
                        ),
                      ),
                    ],
