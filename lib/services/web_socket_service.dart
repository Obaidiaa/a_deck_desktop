...
//         final command = json.decode(message)['command'];
//         final parameters = json.decode(message)['pararmeters'];
//         print('$command  $parameters , $message');
//         if (command == 'getCommandsList') {
//           client.write(json.encode(message));
//         } else if (command == 'StartApplication') {
//           client.write('start Appication $parameters');
//         } else if (command == '') {
//           client.write('object');
//         } else {
